...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(graphviz
     ...
     ;; (conda :variables conda-anaconda-home (find-nix-path "micromamba"))
     (markdown
      :variables
   ...
   '(
     ...
     (dall-e-shell :location (recipe
                              :fetcher github
                              :repo "xenodium/chatgpt-shell"))
     (ob-chatgpt-shell :location (recipe
                                  :fetcher github
                                  :repo "xenodium/chatgpt-shell"))
     (ob-dall-e-shell :location (recipe
                                 :fetcher github
                                 :repo "xenodium/chatgpt-shell"))
     (ox-chameleon :location (recipe
                      :fetcher github
...
(custom-set-variables
 ...
 '(connection-local-criteria-alist
   '(((:application tramp :protocol "kubernetes")
     ...
     ((:application tramp :machine "peranpl1-ml1")
      tramp-connection-local-darwin-ps-profile)
 ...
 '(package-selected-packages
   '(org-modern eglot djvu modus-themes ox-chameleon ob-dall-e-shell
                graphviz-dot-mode company-lua lua-mode typescript-mode
                tree-sitter-langs tree-sitter tsc company-nixos-options
                helm-nixos-options nix-mode nixos-options csv-mode org-ql peg ov
                org-super-agenda ts elgantt fontaine
                info-variable-pitch keycast engrave-faces qpdf sql-indent
                sqlup-mode import-js grizzl js-doc js2-refactor multiple-cursors
                livid-mode nodejs-repl npm-mode skewer-mode js2-mode tern
                clipetty multi-vterm arduino-mode ebuild-mode hoon-mode logcat
                matlab-mode pkgbuild-mode qml-mode scad-mode stan-mode thrift
                vala-mode vala-snippets wolfram-mode csharp-mode attrap cmm-mode
                company-cabal dante lcr flycheck-haskell haskell-mode
                haskell-snippets helm-hoogle hindent hlint-refactor lsp-haskell
                numpydoc pandoc-mode org-noter-pdftools org-pdftools
                org-roam-bibtex org-roam yaml-mode writegood-mode org-starter
                org-reverse-datetree org-ref ox-pandoc citeproc org-noter
                org-kanban org-bullets olivetti langtool helm-bibtex
                bibtex-completion parsebib doom-themes dash-functional biblio
                biblio-core plantuml-mode web-mode web-beautify tagedit
                slim-mode scss-mode sass-mode pug-mode prettier-js
                impatient-mode simple-httpd helm-css-scss haml-mode emmet-mode
                counsel-css company-web web-completion-data
                add-node-modules-path valign org-journal org-tree-slide
                hide-mode-line lsp-latex evil-tex company-reftex company-math
                math-symbol-lists company-auctex auctex org-re-reveal ein
                polymode anaphora websocket ibuffer-projectile centaur-tabs
                helm-rtags google-c-style gendoxy flycheck-ycmd flycheck-rtags
                disaster cpp-auto-include company-ycmd ycmd request-deferred
                company-rtags rtags company-c-headers ccls spotify
                helm-spotify-plus multi reveal-in-osx-finder osx-trash
                osx-dictionary osx-clipboard launchctl toml-mode ron-mode racer
                rust-mode flycheck-rust cargo yapfify stickyfunc-enhance
                sphinx-doc pytest pylookup pyenv-mode pydoc py-isort poetry
                transient pippel pipenv load-env-vars pyvenv pip-requirements
                nose lsp-python-ms lsp-pyright live-py-mode importmagic epc
                ctable concurrent deferred helm-pydoc helm-gtags helm-cscope
                xcscope ggtags dap-mode lsp-treemacs bui lsp-mode markdown-mode
                cython-mode counsel-gtags counsel swiper ivy company-anaconda
                company code-cells blacken anaconda-mode pythonic ws-butler
                writeroom-mode winum which-key volatile-highlights vim-powerline
                ...
                string-edit spacemacs-whitespace-cleanup
                spacemacs-purpose-popwin spaceline-all-the-icons space-doc
                restart-emacs request rainbow-delimiters quickrun popwin pcre2el
                password-generator paradox overseer org-superstar open-junk-file
                nameless multi-line macrostep lorem-ipsum link-hint inspector
                info+ indent-guide hybrid-mode hungry-delete holy-mode hl-todo
                ...
                evil-textobj-line evil-terminal-cursor-changer evil-surround
