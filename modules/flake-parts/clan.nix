  ...
  flake.clan = {
    ...
    inventory = {
      ...
      instances = {
        ...
        # Records: vpn.prestonperanich.com
        dyndns = {
          module = {
            name = "dyndns";
            input = "clan-core";
        ...
        # Scope: user directories only (clan.core.state on the clients);
        # service data dirs (immich, nextcloud, etc.) stay on the ZFS mirror.
        borgbackup = {
          module = {
            name = "borgbackup";
            input = "clan-core";
