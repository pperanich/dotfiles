...
let
  ...
  chemacs2 = pkgs.fetchFromGitHub {
    ...
    sha256 = "sha256-w9mUvpWRqwxWWpZO7AQtpLyOZqS0smrpZwgnRn5iqmg=";
  };
      ...
      (pkgs.emacs-git.overrideAttrs (old: {
        patches =
          ...
          ++ [
            ...
            (pkgs.fetchpatch {
              url = "https://raw.githubusercontent.com/d12frosted/homebrew-emacs-plus/master/patches/emacs-31/fix-window-role.patch";
